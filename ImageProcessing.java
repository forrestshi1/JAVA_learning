...
public class ImageProcessing {
	...
	}/*This method will replace the color of each pixel in the image with the negative version of the pixel. */
...
//Applying a Color Filter
	...
	/*The first method called accepts a which can be a file path or image URL. It returns a 2D array of integers that contains 
	every pixel from the image stored as hexadecimal 
	values containing the RGBA values for the pixel. Take a look at how the method works in the code editor. 
	In the method, we can load image data into a 2D array of s using the method. Note that you can use one of the provided images or load one from a URL.*/
	...
	/*The second provided method is called . It accepts a 2D array of 
	integers and a for the file name. 
	It converts the 2D array of pixel data into an image and saves it.*/

	public static int[] getRGBAFromPixel(int pixelColorValue) {
		Color pixelColor = new Color(pixelColorValue);
		return new int[] { pixelColor.getRed(), pixelColor.getGreen(), pixelColor.getBlue(), pixelColor.getAlpha() };
	}
	/*This method accepts an value representing the pixel hexadecimal value and returns 
	 a 4 element array consisting of the R, G, B, and A values (between 0 and 255).*/
	...
	/*This method accepts an array of integers that represent the RGBA values and convert it into a single value representing 
	 * the pixel hexadecimal value. Take a look at how the method works in the code editor.*/
	...
	/*This method accepts an array of integers that represent the RGBA 
	  values and convert it into a single value representing 
	  the pixel hexadecimal value. */
}